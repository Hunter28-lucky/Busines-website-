...
export default function Footer() {
  return (
    <footer className="bg-[#05060F] border-t border-white/[0.08] py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Goswami</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/portfolio" className="text-gray-500 hover:text-white transition-colors text-sm">
                  Portfolio
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/testimonials" className="text-gray-500 hover:text-white transition-colors text-sm">
                  Testimonials
                </Link>
              </li>
              <li>
